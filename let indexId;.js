...
let deleted_items = 0;
let Tasks = 0;
//<input type="text" id="input" placeholder="Your Next Task">
//<input type="text" id="modal-input" class="mobile-input" placeholder="type here">
...
const loadXml = async () => {
    /*let response = await fetch("http://api.aparat.com/fa/v1/video/video/mostViewedVideos");
